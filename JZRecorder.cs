...
namespace RecordingJZ
{
    ...
    {
        public MyEventArgs(byte[] data, int size,int rec_id)
        {
            this.data = data;
            this.size = size;
            this.rec_id = rec_id;
...

    {
        ...
        public JZRecorder(int dev_id)  
        {

            selectedDeviceId = dev_id;
            ...
            try
            {
                ...
                applicationDevice = new Capture(devices[selectedDeviceId].DriverGuid);                
        ...
        void AnnounceCapturedData()
        {
            ...
            MyEventArgs e=new MyEventArgs(CaptureData,CaptureData.Length,selectedDeviceId);
            HaveData(this,e);
        }
